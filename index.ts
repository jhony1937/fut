...
HaxballJS.then(async (HBInit) => {
  ...
  function applyTeamColors(): void {
    ...
    if (redStreak >= 5) {
      ...
      room.setTeamColors(1, 0, 0x610707, [0xC70404]); // Custom Red (#F5A300 main, #C70404 secondary)
    }
    ...
    if (blueStreak >= 5) {
      ...
      room.setTeamColors(2, 0, 0x0B0791, [0x0B0761]); // Custom Blue (#F5A300 main, #0B0761 secondary)
    }
  }
